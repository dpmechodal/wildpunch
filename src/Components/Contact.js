    ...
    <div> 
        ...
        <div className="first-section bg-dark">
          <div className="container py-200 main-head">
            <h6>CONTACT US</h6>
            <h1 className='extra-size'><span>LET’S TALK.</span><br/>Got a project?</h1>
          ...
          <div className="container py-200">
            <div className="row g-lg-4 g-3 align-items-center">
              <div className="col-12 contact-lets">
                <h4 className='text-black mb-0'>Let's transcend boundaries together and create impactful experiences that resonate with audiences worldwide. Your brand's journey begins here.</h4>
              </div>
