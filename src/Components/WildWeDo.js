    ...
    <div>
      ...
      <div className="sec-section bg-third bg-black first-section">
        <div className="container py-200 pro-max">
          <p data-aos="fade-up" data-aos-duration="100">WILD WE DO</p>
          ...
          <h2 className="mb-0 extra-size" data-aos="fade-up" data-aos-duration="300">
          ...
          <div className="row g-xl-5 g-4">
            <div className="col-lg-4 col-sm-6 col-12">
              <div className="research mobile-re">
                ...
                <h6 data-aos="fade-up" data-aos-duration="200">Your brand's compass.</h6>
                <h6 data-aos="fade-up" data-aos-duration="300">We find your north.</h6>
            ...
            <div className="col-lg-4 col-sm-6 col-12">
              <div className="research mobile-re">
                ...
                <h6 data-aos="fade-up" data-aos-duration="200">Your brand's soul.</h6>
                <h6 data-aos="fade-up" data-aos-duration="300">We find your north.</h6>
                <ul data-aos="fade-up" data-aos-duration="400">
            ...
            <div className="col-lg-4 col-sm-6 col-12">
              <div className="research mobile-re">
                ...
                <h6 data-aos="fade-up" data-aos-duration="200">Your brand's compass.</h6>
                <h6 data-aos="fade-up" data-aos-duration="300">We make it heard.</h6>
                <ul data-aos="fade-up" data-aos-duration="400">
            ...
            <div className="col-lg-4 col-sm-6 col-12">
              <div className="research mobile-re">
                ...
                <h6 data-aos="fade-up" data-aos-duration="200">Your brand's blueprint.</h6>
                <h6 data-aos="fade-up" data-aos-duration="300">We find your north.</h6>
                <ul data-aos="fade-up" data-aos-duration="400">
            ...
            <div className="col-lg-4 col-sm-6 col-12">
              <div className="research mobile-re">
                ...
                <h6 data-aos="fade-up" data-aos-duration="200">Your brand's roadmap.</h6>
                <h6 data-aos="fade-up" data-aos-duration="300">We chart the course.</h6>
                <ul data-aos="fade-up" data-aos-duration="400">
            ...
            <div className="col-lg-4 col-sm-6 col-12">
              <div className="research mobile-re">
                ...
                <h6 data-aos="fade-up" data-aos-duration="200">Your brand's universe.</h6>
                <h6 data-aos="fade-up" data-aos-duration="300">We create its galaxies.</h6>
                <ul data-aos="fade-up" data-aos-duration="400">
            ...
            <div className="col-lg-4 col-sm-6 col-12">
              <div className="research mobile-re">
                ...
                <h6 data-aos="fade-up" data-aos-duration="200">Your brand's story.</h6>
                <h6 data-aos="fade-up" data-aos-duration="300">We bring it to life.</h6>
                <ul data-aos="fade-up" data-aos-duration="400">
        ...
        <div className="container py-200">
          <div className="row g-lg-4 g-3 align-items-center">
            <div className="col-12">
              ...
              <h4 className="text-black mb-0" data-aos="fade-up" data-aos-duration="300">
        ...
        <div className="container py-200 main-head">
          ...
          <div className="d-sm-block d-none">
            <div className="education mt-50">
              <p data-aos="fade-up" data-aos-duration="100">EDUCATION</p>
