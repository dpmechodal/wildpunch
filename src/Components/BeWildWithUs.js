      ...
      <Helmet>
        ...
        <div className="sec-section bg-third bg-black first-section">
          <div className="container py-200">
            <p>BE WILD WITH US</p>
            <h2 className='mb-0 extra-size d-sm-block d-none'><b>Turn your wild ideas into game-changing realities.</b></h2>
            <h2 className='mb-0 extra-size d-sm-none b-block'><b>Turn your <br/>wild ideas into <br/>game-changing <br/>realities.</b></h2>
          </div>
        </div>
          ...
          <div className="container py-200">
            <div className="row g-lg-4 g-3 align-items-center">
              <div className="col-12">
                <h2 className='mb-0 take-the'>Take the first step towards a rewarding future, start your journey with us today.</h2>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="row g-lg-4 g-3 align-items-center">
                ...
                <form className='hello-form row g-md-3 g-0'>
                    ...
                    <div class="mb-md-4 mb-3 ps-md-4 col-md-6 upload-button">
                        ...
                        <a href="#">Attach Portfolio/CV <i class="fa-solid fa-paperclip"></i></a>
                    </div>
