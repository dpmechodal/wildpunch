    ...
    <div>
        ...
        <div className="container py-200">
          <div className="row g-lg-4 g-3 align-items-center">
            <div className="col-12">
              ...
              <h4 className="text-black mb-md-4 mb-3" data-aos="fade-up" data-aos-duration="300">
              ...
              <h4 className="text-black mb-md-4 mb-3" data-aos="fade-up" data-aos-duration="500">
      ...
      <div className="sec-section bg-second" id="OurTeam">
        ...
        <div className="container-fluid py-200 pt-0 px-0">
          <div className="d-sm-block d-none" data-aos="fade-up" data-aos-duration="300">
            <People />
          </div>
          <div className="d-sm-none d-block" data-aos="fade-up" data-aos-duration="300">
            <MobilePeople />
          </div>
        </div>
      </div>
      ...
      <div className="container-fluid py-200 pt-0 px-0" data-aos="fade-up" data-aos-duration="300">
        <Testimonials />
      </div>
